...
# ── Theme (now modularized to desktop/theme.py + desktop/styles.py) ─────────
# Imported for backward compatibility — pages still read globals, but theme.py is the source of truth
...
# Floating presence orb
# ════════════════════════════════════════════════════════════════════════════
# Presence orb now lives in desktop/widgets/orb.py (modularized)
from desktop.widgets.orb import PresenceOrbWidget

# Workers now live in desktop/workers.py (modularized)
