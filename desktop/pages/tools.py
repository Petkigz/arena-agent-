...
from PySide6.QtCore import QBuffer, QIODevice, Qt, Slot
...
from desktop.theme import BG_PRIMARY, BG_SECONDARY, BG_SURFACE, BORDER_SUBTLE, TEXT_PRIMARY, TEXT_MUTED, ACCENT
from desktop.styles import _button_style, _input_style, _textarea_style
from desktop.workers import LocationWorker, CameraThread, CV2_AVAILABLE
