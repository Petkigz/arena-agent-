...
SYNONYMS: Dict[str, List[str]] = {
    ...
    "detect_duplicate_files": ["duplicate detection", "find duplicates",
                               "find duplicate files", "detect duplicates",
                               "detect duplicate", "duplicated files",
                               "duplicate files", "identical files",
                               "dedupe", "dedupe files"],
    "group_files_by_date": ["group by date", "grouped by date",
                            "group files by date", "date-based grouping",
                            "date based grouping", "organize by date",
                            "organise by date", "categorize by date",
