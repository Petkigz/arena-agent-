    ...
    def report(self, *, limit: int = 5000) -> Dict[str, Any]:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                trace_rows = conn.execute(
                    """SELECT trace_id, goal_verified, grounding_result_json,
                       ...
                       FROM cognitive_traces ORDER BY created_at ASC LIMIT ?""",
                    (bounded_limit,),
                ).fetchall()
                feedback_rows = []
        ...
        for row in trace_rows:
            ...
            if grounding:
                ...
                unsupported_claims += len(grounding.get("unsupported_claims") or [])
        ...
        unsupported_rate = round(
            unsupported_claims / grounded_traces, 4
        ) if grounded_traces else None
        ...
        report = {
            ...
            "usefulness_evidence_sufficient": usefulness_count >= 2,
            "strategies": dict(sorted(strategy_rows.items())),
            "note": (
                "These are recorded trace observations. Rates are descriptive; "
