      ...
      <button
        ...
        className={cn(
          ...
          'disabled:opacity-50 disabled:cursor-not-allowed',
          {
            ...
            'bg-background-surface text-text-primary hover:bg-slate-600 active:bg-slate-700': variant === 'secondary',
            'bg-transparent text-text-secondary hover:bg-background-surface active:bg-slate-700': variant === 'ghost',
