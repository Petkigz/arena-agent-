...
│   ├── tools/            # 151 capability tools (manifest) — vision grounding + VLM + LoRA + prosody
...
Current software-only baseline (2026-08-23): **1589 backend passed, 2 skipped, 4 e2e deselected; 184 frontend passed; production frontend build passed**. The measured architecture retains 27/27 deterministic scorecard checks, 151 manifest tools, and 17 wired cognition modules.
