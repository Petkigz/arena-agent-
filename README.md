...
planning queue at `GET /owner-control/autonomous-goals` and inspect stage-by-stage run evidence at `GET /owner-control/autonomy-runs`. For a specific command, the owner can issue
