...
- Full repository suite (2026-09-08, latest — adds the resurrection slice: anticipation engine fed from cognitive cycles, live background observer + event prioritizer, wake-word/voice-overlay/screen-flow mounts, and their endpoint tests): **3,240 passed, 19 skipped, 3 warnings**.
