...
- Full repository suite (2026-09-08, latest — adds the owner live-test fixes: coder-model ranking, destructive-delete escalation, spoken voice replies, workspace static serving, real custom wake-word training, desktop screen watcher, parked-goal auto-recheck, decision trace): **3,259 passed, 19 skipped, 5 warnings**.
