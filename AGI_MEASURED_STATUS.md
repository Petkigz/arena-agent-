...
3. Add cooperative cancellation and rollback receipts for long-running tools. Emergency pause prevents new work and project revocation is checked between steps, but an already-running synchronous tool cannot always be interrupted or reversed.
