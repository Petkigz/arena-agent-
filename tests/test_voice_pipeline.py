...
class TestVoiceActivityDetector:
    ...
    def test_initialization(self):
        ...
        with patch.object(VoiceActivityDetector, '_load_model'):
    ...
    def test_speech_detection(self):
        ...
        with patch.object(VoiceActivityDetector, '_load_model'), \
             patch('backend.voice.vad.torch') as mock_torch:
            ...
            # Mock torch.from_numpy to return a mock tensor
            mock_tensor = Mock()
...
class TestVoiceService:
    ...
    async def test_update_settings(self, service):
        ...
        with patch('backend.voice.service.VoicePipeline') as mock_pipeline:
            ...
            mock_instance.update_wake_word = AsyncMock()
            mock_pipeline.return_value = mock_instance
